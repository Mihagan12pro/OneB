...
// OneB.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(COneBApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &COneBApp::OnAppAbout)
...
COneBApp::COneBApp() noexcept
{
	...
	SetAppID(_T("OneB.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект COneBApp

COneBApp theApp;


// Инициализация COneBApp

BOOL COneBApp::InitInstance()
{
...
// Обработчики сообщений COneBApp
